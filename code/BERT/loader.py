...
def prepare_dataset(sentences, word_dim, char_dim, word_to_id, id_to_word, char_to_id, tag_to_id, lower=False, mask= True, mask_per = 0.2, train = False):
    ...
    bert_words = [' '.join(x) for x in temp_words]
    ...
    return words, chars, caps, tags, bert_words
...
def create_custom_objects():
    ...
    return {"CRF": ClassWrapper, "crf_loss": loss, "crf_marginal_accuracy": accuracy}#crf_viterbi_accuracy
